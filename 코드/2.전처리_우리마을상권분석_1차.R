...
library(tidyverse)
#폴더 지정
setwd('C:/Users/ChangYong/Desktop/나노디그리/1.정규강의 학습자료/1차 프로젝트/소상공인/데이터/원본데이터/우리마을 상권분석 서비스 데이터/1501_2009_1차')
getwd()
...
#smallbz_data에 임대료 데이터 추가
smallbz_data <- merge(x = smallbz_data, y = rent_data, by=c("년도","분기","행정구역"), all.x=T)
